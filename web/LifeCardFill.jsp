            ...
            <table border='1'>
                ...
                <tr>
                    ...
                    <td width='60%' style="height: 450px">
                        <form name='form1' action="OK.jsp" onSubmit="return myCheck()">
                            <table align="center" style="border-spacing:30px 20px;">
                                ...
                                <tr>
                                    <td align="right"><input id="submit" type="submit" value="OK" style="background-color:#009999;width: 80px;height: 25px"></td>
